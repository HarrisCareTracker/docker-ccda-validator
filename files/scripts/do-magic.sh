...
curl -L https://github.com/onc-healthit/reference-ccda-validator/releases/download/v1.1.4/referenceccdaservice.war > /var/lib/tomcat/webapps/referenceccdaservice.war
